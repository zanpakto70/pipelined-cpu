...
# &#x20; cpu\_pipelined.vhd          top level: datapath wiring, muxes, PC select

# &#x20; pc\_reg.vhd                 program counter register
...
# &#x20; sign\_extend.vhd            sign / zero extend and lui shift

# &#x20; dcache.vhd                 data memory (32 words)

# &#x20; control\_unit.vhd           opcode + funct decode

# &#x20; hazard\_and\_forwarding.vhd  hazard detection unit + forwarding unit

# &#x20; if\_id\_reg.vhd              IF/ID pipeline register (stall + flush)

# &#x20; id\_ex\_reg.vhd              ID/EX pipeline register (flush)

# &#x20; ex\_mem\_reg.vhd             EX/MEM pipeline register

# &#x20; mem\_wb\_reg.vhd             MEM/WB pipeline register
...
# Signals worth watching: `if\_pc\_current` for pipeline progress, `stall` and

# `forward\_a` / `forward\_b` for hazard activity, and `wb\_reg\_d\_in` alongside

# `wb\_write\_addr` for committed results.
